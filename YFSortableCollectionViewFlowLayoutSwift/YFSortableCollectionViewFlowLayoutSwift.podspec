Pod::Spec.new do |s|
    ...
    s.platform     = :ios, "8.0"
    s.source       = { :git => "https://github.com/ghostfeng/Swift-Demo.git", :tag => "s.version" }
    s.source_files  = "YFSortableCollectionViewFlowLayoutSwift/YFSortableCollectionViewFlowLayoutSwift/**/*.{swift}"
    s.frameworks = "UIKit"
